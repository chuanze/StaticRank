        ...
        Handlebars.registerHelper('sales', function(option) {
            if (this.sales == 0)
                return "0";
            else
                return this.sales / 10000.00;
        });
        Handlebars.registerHelper('kpi', function(option) {
            if (this.kpi == 0)
                return "0";
            else
                return this.kpi / 10000.00;
        });
        ...
        function pullUpAction() {
            var params = param_data("c01977c3-2269-46ea-b21a-c8bbf01ff7c9", String(topIndex), String(pageIndex));
            ...
            setTimeout(function() { // <-- Simulate network congestion, remove setTimeout from production!
                ...
                $.ajax({
                    ...
                    data: null, //JSON.stringify(params),
                    async: true,
        ...
        $(function() {
            ...
            var paramtop = param_data("c01977c3-2269-46ea-b21a-c8bbf01ff7c9", "3", "1");
            ...
            var params = param_data("c01977c3-2269-46ea-b21a-c8bbf01ff7c9", "0", "1");
            // params.sessionid = "61c324e4-b80f-42e7-bae4-b47b907d5731";
            // params.enterprisenumber = "1008637";
            // params.usernumber = "631877";
            // params.params.usernumber = "631877";
            $.ajax({
                url: "data/SalesTop.json",
                type: "get",
                contentType: "application/json;utf-8",
                data: null, //JSON.stringify(paramtop),
                async: true,
                dataType: 'json',
        ...
        function event_click(e) {
            ...
            switch (e) {
                case 0:
                    ...
                    load_data("data/Sales.json", "0", "#forday");
                    break;
                case 1:
                    console.log("昨日排行");
                    topIndex = 1;
                    $("#topM").addClass("bw");
                    $("#topM").siblings().removeClass("bw");
                    load_data("data/Sales.json", "1", "#forday");
                    break;
                case 2:
                    console.log("今月排行");
                    topIndex = 2;
                    ...
                    load_data("data/Sales.json", "2", "#formonth");
                    break;
                default:
                    console.log("点击参数出错！");
                    break;
        ...
        function load_data(_url, _querytype, _forwhat) {
            var dataparam = param_data("c01977c3-2269-46ea-b21a-c8bbf01ff7c9", String(_querytype), String(pageIndex));
            ...
            $.ajax({
                ...
                contentType: "application/json",
                // dataType: "json",
                data: null, //JSON.stringify(dataparam),
                async: true,
                dataType: 'json',
                success: function(e, a, b) {
                    if (e.error_msg != undefined) {
